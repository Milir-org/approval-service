...
Microservice responsible for `/api/approvals`.

Runs on port **8083** and is proxied through the API gateway at `/api`.
...
The canonical source lives in the [spark-ai monorepo](https://github.com/Milir-org/spark-ai) under `artifacts/approval-service/`. This repo is an extracted, self-contained mirror.
